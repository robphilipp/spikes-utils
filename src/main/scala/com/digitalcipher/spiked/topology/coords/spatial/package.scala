...
//  def toCartesian(coordinate: Cartesian): Cartesian = coordinate
//  def toCylindrical(coordinate: Cylindrical): Cylindrical = coordinate
//  def toSpherical(coordinate: Spherical): Spherical = coordinate

  /*
    CONVERSIONS: cartesian <--> cylindrical
   */
